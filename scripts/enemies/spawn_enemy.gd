...
@onready var camera: Camera3D = LevelController.camera
...
func _spawn_enemies() -> void:
	...
	Global.scene_controller.config_next_area(amount, unlocked_at_area)
	if last_area: Global.scene_controller.last_area = true
